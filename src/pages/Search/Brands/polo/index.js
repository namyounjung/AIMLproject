...
import main from "../../../assets/image/polo.svg";
import logoimg from "../../../assets/logo2/polo.svg";
// import url from 'http://www.mujikorea.net/';
import brandList from "../../detail/object.js";
import sun from "../../../assets/weather/sun.svg";
import rain from "../../../assets/weather/rain.svg";
import cloud from "../../../assets/weather/cloud.svg";
import data from "./polo_data.js";
...
export default function POLO() {
  ...
  function handleToggleFavoriteItem() {
    ...
    if (isFavorite === true) {
      ...
      parsedUser.favoriteBrandList.push("polo");
      setIsFavorite(true);
    }
  ...
  return (
    <div className={brandsCss.brandsWrapper}>
      ...
      <div className={brandsCss.imageWrapper}>
        <a
          href="https://www.ralphlauren.co.kr/"
          target="_blank"
        >
          <img
            src={main}
