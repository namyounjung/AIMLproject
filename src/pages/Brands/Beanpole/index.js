...
import main from "../../../assets/image/beanpole.svg";
import logoimg from "../../../assets/logo2/beanpole.svg";
// import url from 'http://www.mujikorea.net/';
import brandList from "../../detail/object.js";
import sun from "../../../assets/weather/sun.svg";
import rain from "../../../assets/weather/rain.svg";
import cloud from "../../../assets/weather/cloud.svg";
import data from "./beanpole_data.js";
...
export default function BeanPole() {
  ...
  function handleToggleFavoriteItem() {
    ...
    if (isFavorite === true) {
      parsedUser.favoriteBrandList = parsedUser.favoriteBrandList.filter(
        (value) => value !== "beanpole"
      );
      setIsFavorite(false);
    } else {
      parsedUser.favoriteBrandList.push("beanpole");
      setIsFavorite(true);
    }
